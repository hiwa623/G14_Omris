...
<div class="wrap">
  ...
  <div class="header">
    <div class="tabs">
      <a class="tab" href="${pageContext.request.contextPath}/HallBeforeServlet">提供前一覧</a>
      <a class="tab active" href="${pageContext.request.contextPath}/HallServedServlet">完了済み商品</a>
    </div>
