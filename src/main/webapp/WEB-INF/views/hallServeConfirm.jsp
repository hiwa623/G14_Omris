...
<div class="wrap">
  <div class="card">
    ...
    <div class="btns">
      <a class="btnLink" href="${pageContext.request.contextPath}/HallBeforeServlet">いいえ</a>
      <form method="post" action="${pageContext.request.contextPath}/HallServeCompleteServlet">
