...
<head>
  ...
  <style>
    ...
    .toggleLink{ display:inline-block; width: 46px; height: 26px; border-radius: 999px; background:#f1b5b5; position: relative; border:1px solid #d8aaaa; vertical-align: middle; }
    .toggleLink::after{ content:""; width: 20px; height: 20px; border-radius: 50%; background:#000; position:absolute; top: 2px; left: 3px; }
...
<div class="wrap">
  ...
  <div class="header">
    <div class="tabs">
      <a class="tab active" href="${pageContext.request.contextPath}/HallBeforeServlet">提供前一覧</a>
      <a class="tab" href="${pageContext.request.contextPath}/HallServedServlet">完了済み商品</a>
    </div>
