...
<head>
  ...
  <style>
    ...
    .btn {
      ...
      background: #fff; border: 3px solid #1e88ff;
    }
  </style>
</head>
<body>
<div class="wrap">
  <div class="card">
    ...
    <div class="btns">
      <a class="btnLink" href="${pageContext.request.contextPath}/kitchen">いいえ</a>
      <form method="post" action="${pageContext.request.contextPath}/kitchen/complete">
