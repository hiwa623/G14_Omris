...
<head>
  ...
  <style>
    ...
    .tab { padding: 10px 14px; border-radius: 8px; text-decoration:none; border: 1px solid #ddd; color:#000; background:#fff; }
    ...
    .toggleLink{ display:inline-block; width: 46px; height: 26px; border-radius: 999px; background:#c8f0c8; position: relative; border:1px solid #a7d7a7; vertical-align: middle; }
    .toggleLink::after{ content:""; width: 20px; height: 20px; border-radius: 50%; background:#000; position:absolute; top: 2px; left: 23px; }
...
<div class="wrap">
  <div class="header">
    <div class="tabs">
      <a class="tab" href="${pageContext.request.contextPath}/KitchenServlet">注文料理一覧</a>
      <a class="tab active" href="${pageContext.request.contextPath}/KitchenCompletedServlet">完了済み商品</a>
    </div>
    <div class="count">完了件数：<c:out value="${completedList == null ? 0 : completedList.size()}" />件</div>
  </div>
