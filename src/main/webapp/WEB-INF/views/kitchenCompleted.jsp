...
<head>
  ...
  <style>
    ...
    .centerBtnWrap { flex: 1; display:flex; justify-content:center; gap: 10px; }
    .greenBtn {
      display:inline-block; padding: 10px 18px; border-radius: 999px;
      background: #4caf50; color: #fff; text-decoration:none;
      font-weight: 700; border: 1px solid #3c8f40;
    }
    .clearBtn {
      padding: 10px 18px; border-radius: 999px; border: 1px solid #999;
...
<div class="wrap">
  ...
  <div class="header">
    ...
    <div class="count">
      完了件数：
      <c:out value="${completedList == null ? 0 : completedList.size()}" />件
    </div>
  </div>
